...
class Fontawesomebrands implements CssInterface, JavascriptInterface
{
    ...
    public function getCss(string $version)
    {
        switch ($version) {
            ...
            case '5.1.1.*':
                $data = array(
                    'href' => 'https://use.fontawesome.com/releases/v5.1.1/css/brands.css',
            ...
            case '5.0.12.*':
                $data = array(
                    'href' => 'https://use.fontawesome.com/releases/v5.0.12/css/brands.css',
    ...
    public function getJavascript(string $version)
    {
        switch ($version) {
            ...
            case '5.0.12.*':
                $data = array(
                    'src' => 'https://use.fontawesome.com/releases/v5.0.12/js/brands.js',
